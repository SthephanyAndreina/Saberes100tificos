...
export const CONTENT_SCHEMA = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "objetivo", label: "Objetivo general", type: "textarea" },
      { name: "adscripcion", label: "Adscripción a la USB", type: "textarea" },
    ],
  },
  {
    key: "usb",
    label: "Reseña de la USB",
    fields: [
      { name: "title", label: "Título", type: "text" },
      { name: "resena", label: "Reseña", type: "textarea" },
      { name: "ubicacion", label: "Ubicación", type: "textarea" },
      { name: "historia", label: "Historia", type: "textarea" },
    ],
  },
  {
    key: "taller",
